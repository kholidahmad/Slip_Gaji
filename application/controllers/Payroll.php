    ...
    class Payroll extends CI_Controller
    {
        ...
        public function kirim_slip()
        {
            ...
            $config = [
                ...
                'smtp_user' => 'epayslipnusindo@nusindo.co.id',
                'smtp_pass' => 'eP4Y5L1P2022**',
                'smtp_port' => 465,
                'mailtype' => 'html',
                'charset' => 'utf-8',
                'newline' => "\r\n",
            ...
            $slip = base_url() . "assets/images/slip.png";
            $this->email->attach($filename);
            $this->email->attach($slip);
            $cid = $this->email->attachment_cid($filename);
            $cid_slip = $this->email->attachment_cid($slip);
            ...
            for ($i = 0; $i < $jml_email; $i++) {
                ...
                // Email sent from :
                $this->email->from('epayslipnusindo@nusindo.co.id', 'SLIP GAJI PT. Rajawali Nusindo');
                $this->email->to($salary_list[$i]['email']);
                $this->email->subject("Slip Gaji " . $bulan[$salary_list[0]['bulan']] . " " . $salary_list[0]['tahun'] . " ");

                // total potongan
                $total_potongan =
                    $salary_list[$i]['pot_pph'] +
                    $salary_list[$i]['pot_pensiun'] +
                    $salary_list[$i]['pot_jamsostek'] +
                    $salary_list[$i]['pot_bpjs_kes'] +
                    $salary_list[$i]['pot_bpjs_tkj'] +
                    $salary_list[$i]['pot_uang_muka'] +
                    $salary_list[$i]['pot_dplk'] +
                    $salary_list[$i]['pot_koperasi'] +
                    $salary_list[$i]['pot_sumbangan_amount'] +
                    $salary_list[$i]['pot_lain'];
                                            ...
                                            <td valign="top" width="100%" style="padding-top: 5px;">
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                                                    ...
                                                    <tr style="background-color: #f2f2f2;">
                                                        ...
                                                        <td style="text-align: left; padding-right: 10px;">
                                                            <b class="heading"> ' . $salary_list[$i]['jabatan'] . ' </b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: left; padding-right: 10px;">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left; padding-right: 10px;">
                                                            <b class="heading"> CABANG </b>
                                                        </td>
                                                        <td width="2%" style="text-align: left; padding-right: 10px;">
                                                            <b class="heading"> : </b>
                                                        </td>
                                                        <td style="text-align: left; padding-right: 10px;">
                                                            <b class="heading"> ' . $salary_list[$i]['cabang'] . ' </b>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                                                    <tr>
                                                        ...
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            ...
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;"> ('  . $salary_list[$i]['golongan'] . "/" . $salary_list[$i]['tangga'] . ")=" . number_format($salary_list[$i]['gp']) . '</td>
                                                        </tr>
                                                        <tr style="height: 5px;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                TUNJ. KELUARGA 
                                                            ...
                                                            <td width="2%" style="height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                ' . number_format($salary_list[$i]['gp']) . ' X ' . $salary_list[$i]['tk'] . ' = ' . number_format($salary_list[$i]['tk_amount']) . '  
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr style="height:5px;">
                                                        ...
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            ...
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                Rp ' . number_format($salary_list[$i]['tj_pajak']) . ' 
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                            ...
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                Rp ' . number_format($salary_list[$i]['tj_lembur']) . ' 
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                        ...
                                                        <tr style="text-align: left; padding-right: 10px;">
                                                            <td colspan="3" style="background-color: #0054a6;">
                                                                <b class="heading" style="display:flex;align-items:center;color:white;padding-left:5px;"> POTONGAN </b>
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                        ...
                                                        <tr style="height: 5px;">
                                                            ...
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                Rp ' . number_format($salary_list[$i]['pot_koperasi']) . ' 
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                            ...
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                Rp ' . number_format($salary_list[$i]['pot_sumbangan_amount']) . ' 
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                                                    <tr>
                                                        ...
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            ...
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                Rp ' . number_format($total_potongan) . '
                                                            </td>
                                                        </tr>
                                                        <tr style="height: 5px; background-color: #f2f2f2;">
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                <b style="color:blue;font-size: large;margin:5px;word-wrap: break-word;">JUMLAH DIBAYAR</b>
                                                            </td>
                                                            <td style="table-layout: auto;width: 2px; height: 5px; text-align: left; padding-right: 10px;">:</td>
                                                            <td style="height: 5px; text-align: left; padding-right: 10px;">
                                                                <b style="color:blue;font-size: large;margin:5px;word-wrap: break-word;">Rp ' . number_format($salary_list[$i]['gaji_bayar']) . '</b>
                                                            </td>
                                                        </tr>
                                                    </tr>
                                                </table>
                                            ...
                                            <td valign="top" width="100%" style="padding-top: 5px;">
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                                                    <tr>
                                                        <tr style="text-align: left; padding-right: 10px;">
                                                            <td colspan="3">
                                                                <img width="80px;" style="float: right;" src="cid:' . $cid_slip . '" alt="pdf surat slip" />
                                                            </td>
                                                        </tr>
                                                    </tr>
                                                </table>
            ...
            if (isset($_FILES['uploadFile']['name']) && in_array($_FILES['uploadFile']['type'], $file_mimes)) {
                ...
                for ($i = 1; $i < count($sheet_data); $i++) {
                    $data = array(
                        ...
                        'golongan' => $sheet_data[$i]['3'],
                        'tangga' => $sheet_data[$i]['4'],
                        'jabatan' => $sheet_data[$i]['5'],
                        'gp' => $sheet_data[$i]['6'],
                        'tk' => $sheet_data[$i]['7'],
                        'tk_amount' => $sheet_data[$i]['8'],
                        'gp_tk' => $sheet_data[$i]['9'],
                        'faktor' => $sheet_data[$i]['10'],
                        'gdp_amount' => $sheet_data[$i]['11'],
                        'tj_jabatan' => $sheet_data[$i]['12'],
                        'tj_struktur' => $sheet_data[$i]['13'],
                        'tj_merit' => $sheet_data[$i]['14'],
                        'tj_beras' => $sheet_data[$i]['15'],
                        'tj_transport' => $sheet_data[$i]['16'],
                        'tj_rumah' => $sheet_data[$i]['17'],
                        'tj_listrik' => $sheet_data[$i]['18'],
                        'tj_ops' => $sheet_data[$i]['19'],
                        'tj_bansos' => $sheet_data[$i]['20'],
                        'tj_lembur' => $sheet_data[$i]['21'],
                        'tj_skala' => $sheet_data[$i]['22'],
                        'tj_peralihan' => $sheet_data[$i]['23'],
                        'tj_kemahalan' => $sheet_data[$i]['24'],
                        'tj_lain' => $sheet_data[$i]['25'],
                        'tj_komp_ump' => $sheet_data[$i]['26'],
                        'tj_pajak' => $sheet_data[$i]['27'],
                        'gaji_kotor' => $sheet_data[$i]['28'],
                        'pot_pph' => $sheet_data[$i]['29'],
                        'pot_pensiun' => $sheet_data[$i]['30'],
                        'pot_jamsostek' => $sheet_data[$i]['31'],
                        'pot_bpjs_kes' => $sheet_data[$i]['32'],
                        'pot_bpjs_tkj' => $sheet_data[$i]['33'],
                        'pot_dplk' => $sheet_data[$i]['34'],
                        'pot_uang_muka' => $sheet_data[$i]['35'],
                        'gaji_bersih' => $sheet_data[$i]['36'],
                        'pot_koperasi' => $sheet_data[$i]['37'],
                        'pot_sumbangan_amount' => $sheet_data[$i]['38'],
                        'pot_lain' => $sheet_data[$i]['39'],
                        'gaji_bayar' => $sheet_data[$i]['40'],
                        'bulan' => $sheet_data[$i]['41'],
                        'tahun' => $sheet_data[$i]['42'],
                        'cabang' => $sheet_data[$i]['43'],
                    );
                    $array_data[] = $data;
                }
